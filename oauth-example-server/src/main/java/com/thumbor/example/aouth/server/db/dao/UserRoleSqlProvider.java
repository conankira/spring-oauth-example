...
import com.thumbor.example.aouth.server.db.entity.UserRoleExample.Criteria;
import com.thumbor.example.aouth.server.db.entity.UserRoleExample.Criterion;
...
public class UserRoleSqlProvider {
    ...
    public String countByExample(UserRoleExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("tbl_user_role");
    ...
    public String insertSelective(UserRole record) {
        ...
        if (record.getRole_id() != null) {
            sql.VALUES("role_id", "#{role_id,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getRole_id() != null) {
            sql.SET("role_id = #{record.role_id,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(UserRole record) {
        ...
        if (record.getRole_id() != null) {
            sql.SET("role_id = #{role_id,jdbcType=INTEGER}");
        }
