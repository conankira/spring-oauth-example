...
import com.thumbor.example.aouth.server.db.entity.RoleExample.Criteria;
import com.thumbor.example.aouth.server.db.entity.RoleExample.Criterion;
...
public class RoleSqlProvider {
    ...
    public String countByExample(RoleExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("tbl_role");
